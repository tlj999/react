    ...
    return function (Comp) {
        ...
        class FormComponent extends React.Component{
            constructor(props){
                ...
                this.handerValueChange=this.handerValueChange.bind(this);
                this.setFormValues=this.setFormValues.bind(this);
            }
            handerValueChange(fieldName,value){
                ...
                for(const field in form){
                    if(form.hasOwnProperty(field)){
                        if(typeof values[field]!=='undefined'){
                            newForm[field]={...newForm[field],values:values[field]}
                        }
            ...
            render(){
                ...
                return <Comp {...this.props} form={form} formValid={formValid} setFormValues={this.setFormValues} onFormChange={this.handerValueChange}/>
            }
        }
